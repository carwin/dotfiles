...
and unpack relevant values.  These settings are configured in
=./Systems.org= and tangled out to the directory specified above.
...
@todo: testing block.
#+begin_src emacs-lisp
(cy/system-settings-get 'dotfiles/dir)
