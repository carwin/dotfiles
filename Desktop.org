...
alias dots='cd ~/Projects/Home/sys/dotfiles'
alias work='cd ~/Projects/Work'
alias notes='cd ~/Documents/Notes'
alias docs='cd ~/Documents'
alias mine-rvn='~/Documents/Cryptocurrency/Mining/RVN/t-rex/t-rex -c ~/Documents/Cryptocurrency/Mining/RVN/t-rex-config.json'
alias mine-nicehash='sudo ~/Documents/Cryptocurrency/Mining/NiceHash/PhoenixMiner/PhoenixMiner'
...
# Setup ruby prompt
#count_rbs=`find . -maxdepth 1 -type f -name "*.rb" | wc -l`;
#count_gemfile=`find . -maxdepth 1 -type f -name "Gemfile" | wc -l`;

# function ruby_version()
# {
#   if [ $count_rbs != 0 ] || [ $count_gemfile != 0 ]; then
#     if which rvm-prompt &> /dev/null; then
#         #echo "%F{225}(%F{212} $(rvm-prompt i v g) %F{225})"
#         rvm-prompt i v g
#     else
...
# PassCmd "~/Scripts/emacs-mail-sync.sh work"
PassCmd "secret-tool lookup user carwin@mobomo.com host imap.gmail.com"
SSLType IMAPS
...
##########################
# narwic@1000needles.net #
##########################
IMAPAccount home
Host mail.runbox.com
Port 993
User narwic@1000needles.net
# PassCmd "~/Scripts/emacs-mail-sync.sh home"
PassCmd "secret-tool lookup user narwic@1000needles.net host mail.runbox.com"
SSLType IMAPS
SSLVersions TLSv1.2
CertificateFile /etc/ssl/certs/ca-certificates.crt
...
[general]
ui = ttyui
accounts = 1000needles, Mobomo
#pythonfile=~/.config/mutt/offlineimap.py
fsync = False

[Account 1000needles]
localrepository = 1000needles-Local
remoterepository = 1000needles-Remote
postsynchook = notmuch new

[Repository 1000needles-Local]
type = Maildir
localfolders = ~/.mail/narwic@1000needles.net

[Repository 1000needles-Remote]
maxconnections = 1
type = IMAP
remotehost = mail.runbox.com
ssl = yes
remoteuser = narwic@1000needles.net
...
sslcacertfile = /etc/ssl/certs/ca-certificates.crt
remotepassfile = /tmp/pw-work.txt
realdelete = no
#+end_src
...
#+begin_src conf :tangle ~/.local/share/applications/qute_home.desktop :mkdirp yes
;;[Desktop Entry]
;;Type=Application
;;Version=1.0
...
#+begin_src conf :tangle ~/.local/share/applications/qute_work.desktop :mkdirp yes
  ;;[Desktop Entry]
  ;;Type=Application
  ;;Version=1.0
...
#+begin_src conf :tangle ~/.config/systemd/user/onedrive-sync.service :mkdirp yes
[Unit]
...
#+begin_src conf :tangle ~/.config/systemd/user/onedrive-sync.timer :mkdirp yes
[Unit]
