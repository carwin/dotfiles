...
- [[#environment][Environment]]
  ...
  - [[#git][Git]]
    - [[#primary-gitconfig][Primary .gitconfig]]
  - [[#window-manager][Window Manager]]
    - [[#i3][i3]]
      - [[#primary-i3wm-configuration][Primary i3wm Configuration]]
      - [[#i3-scripts][i3 Scripts]]
        - [[#autostart-with-i3][Autostart with i3]]
        - [[#i3lock][i3lock]]
        - [[#i3s-dunst-launcher][i3's Dunst Launcher]]
        - [[#i3s-polybar-launcher][i3's Polybar Launcher]]
        - [[#i3s-compositor-launcher][i3's Compositor Launcher]]
    - [[#polybar][Polybar]]
      - [[#polybar-modules][Polybar Modules]]
        ...
        - [[#generic--combined-network][Generic / Combined Network]]
        - [[#volume][Volume]]
        - [[#temperature][Temperature]]
        - [[#menu-application-launcher][Menu (Application launcher)]]
        - [[#sysmenu-power][Sysmenu (Power)]]
- [[#applications][Applications]]
  - [[#dunst][Dunst]]
    - [[#global][Global]]
    - [[#shortcuts][Shortcuts]]
    - [[#notification-styles][Notification Styles]]
      - [[#low-priority-notifications][Low-priority Notifications]]
      - [[#normal-notifications][Normal Notifications]]
  ...
  - [[#rofi][Rofi]]
    - [[#bins][Bins]]
      ...
      - [[#confirm][Confirm]]
      - [[#launcher][Launcher]]
      - [[#mpd-control-via-rofi][MPD Control via Rofi]]
      - [[#network][Network]]
    ...
    - [[#themes][Theme(s)]]
      ...
      - [[#network][Network]]
      - [[#network-menu][Network Menu]]
      - [[#network-menu-config][Network Menu Config]]
      - [[#mpd][MPD]]
      - [[#power-menu][Power Menu]]
      - [[#screenshot][Screenshot]]
  - [[#tmux][Tmux]]
  ...
  - [[#firefox][Firefox]]
    ...
    - [[#usercontentcss][userContent.css]]
...
#+begin_src shell :tangle ~/.config/i3/bin/launch-dunst.sh :mkdirp yes :tangle-mode (identity #o755)
#!/usr/bin/env bash
if [[ `pidof dunst` ]]; then
	pkill dunst
fi
