...
alias dots='cd <<dotfiles-location()>>'
...
#+begin_src conf :tangle (concat (cy/system-settings-get 'user/config) "zsh/.zshrc")
<<zshrc>>
#+end_src
...
#+begin_src conf :noweb yes :tangle (tangle-linux (cy/system-settings-get 'user/home) ".Xresources")
<<xresources-config>>
#+end_src
...
~/.Xresources~. For convenience, evaluate this block:
...
#+begin_src conf :tangle (tangle-linux (cy/system-settings-get 'user/config) "xsettingsd/xsettingsd.conf")
Xft/Antialias 1
Xft/Hinting 1
Xft/HintStyle "hintslight"
Xft/RGBA "rgb"
...
#+begin_src emacs-lisp :noweb yes :tangle (tangle-linux (cy/system-settings-get 'user/config) "i3/config")
<<i3config>>
#+end_src
...
#+begin_src sh :noweb yes :tangle (tangle-linux (cy/system-settings-get 'user/config) "i3/bin/autostart.sh")
<<i3-autostart-script>>
#+end_src
...
#+begin_src sh :noweb yes :tangle (tangle-linux (cy/system-settings-get 'user/config) "i3/bin/i3lock.sh")
<<i3-lock-script>>
#+end_src
...
#+begin_src sh :tangle (tangle-linux (cy/system-settings-get 'user/config) "i3/bin/launch-dunst.sh")
if [[ `pidof dunst` ]]; then
    pkill dunst
fi
...
#+begin_src sh :noweb yes :tangle (tangle-linux (cy/system-settings-get 'user/config) "i3/bin/launch-polybar.sh")
<<i3-polybar-launcher>>
#+end_src
...
#+begin_src sh :noweb yes :tangle (tangle-linux (cy/system-settings-get 'user/config) "i3/bin/launch-compton.sh")
...
#+begin_src conf :tangle (tangle-linux (cy/system-settings-get 'user/config) "polybar/colors.ini")
[color]
BG = #1e222a
BGL = #2c3038
FG = #c8ccd4
...
#+begin_src scss :tangle (tangle-linux (cy/system-settings-get 'user/config) "rofi/themes/launcher.rasi")
configuration {
  font: 				"JetBrains Mono Medium 10";
  // bw: 					0;
  location: 				0;
...
#+begin_src emacs-lisp :noweb yes :tangle (concat (cy/system-settings-get 'user/home) ".vimrc")
<<vim-config>>
#+end_src
