...
* General
:PROPERTIES:
:ID:       0b11c88d-1c08-4fe6-b61f-61d313240992
:END:
...
* Package Management
:PROPERTIES:
:ID:       25b067cb-6690-4e95-98de-744ae84018fc
:END:
...
:PROPERTIES:
:ID:       654dbb95-33cc-4eeb-b4fe-c3037b0be5cd
:END:
...
:PROPERTIES:
:ID:       234adf8b-a36a-4e9d-922c-e8526d661cb1
:END:
...
* Keep .emacs.d Clean
:PROPERTIES:
:ID:       e91f88be-04c4-4122-b093-73dea9b77826
:END:
...
** Turn on Evil mode
:PROPERTIES:
:ID:       19e53e2a-d531-493f-9bec-603788d60267
:END:
...
:PROPERTIES:
:ID:       9914a048-e668-41a3-96c8-4b66e278a69f
:END:
...
#+begin_src emacs-lisp
  ...
  ;;   "fde" '((lambda () (interactive) (find-file (expand-file-name "~/Projects/Home/sys/dotfiles/Emacs.org"))) :which-key "edit config")
  ;;   "fdE" '((lambda () (interactive) (cy/org-file-show-headings "~/Projects/Home/sys/dotfiles/Emacs.org")) :which-key "edit config")
  ;;   "fdD" '((lambda () (interactive) (find-file (expand-file-name "~/Projects/Home/sys/dotfiles/Desktop.org"))) :which-key "workflow")
  ;;   "fdS" '((lambda () (interactive) (find-file (expand-file-name "~/Projects/Home/sys/dotfiles/Systems.org"))) :which-key "workflow")
  ;;   "fdW" '((lambda () (interactive) (find-file (expand-file-name "~/Projects/Home/sys/dotfiles/Workflow.org"))) :which-key "workflow"))
#+end_src

* Stateful Keymaps with Hydra
:PROPERTIES:
:ID:       957af07b-4fdf-4439-9f5b-e5680fde197c
:END:
...
** Flycheck
:PROPERTIES:
:ID:       1602af4d-c193-4a29-9e4b-880ec66bb733
:END:
#+begin_src emacs-lisp
...
:PROPERTIES:
:ID:       e29c446d-bfb7-4de9-8efe-7166bb22b6e0
:END:
...
:PROPERTIES:
:ID:       859e9760-c9c5-4dd4-90d8-16bffa370f65
:END:
...
* Expand Region
:PROPERTIES:
:ID:       8c0a90d4-fd7c-4433-97af-510d797215b9
:END:
...
** Dired
:PROPERTIES:
:ID:       3c3b6ddb-a5fd-4f5a-b4d0-f3e6d833279c
:END:
...
** Deft
:PROPERTIES:
:ID:       7eb5033a-54e3-4c32-8634-98ac02f4ee7b
:END:
...
* Org Mode
:PROPERTIES:
:ID:       f1c3d85f-4206-45dc-a2a6-8e6d07933b6b
:END:
...
:PROPERTIES:
:ID:       b57451c5-d8d0-4a50-a838-6fed561f4b3f
:END:
...
:PROPERTIES:
:ID:       63af966a-710b-4971-906b-6d94190c2758
:END:
...
** Fonts and Bullets
:PROPERTIES:
:ID:       fbdf9e80-9486-4989-b761-fef7a28f75c2
:END:
...
** Structure Templates
:PROPERTIES:
:ID:       bebac89d-723c-4eb7-b18c-59efe14312f7
:END:
...
** Pomodoro
:PROPERTIES:
:ID:       202a3af1-9a1f-45e2-a38e-00bca04114ff
:END:
...
** Protocol
:PROPERTIES:
:ID:       13106fb6-3be1-4ba1-9dcb-571c870a8d82
:END:

Probably not needed if using custom functions invoked through =emacsclient=.
...
** Searching
:PROPERTIES:
:ID:       b9c33599-8a5a-4529-b46c-725f49589318
:END:
...
** Bindings
:PROPERTIES:
:ID:       9356024c-a6f3-45ac-9bd5-d02ac363f4a9
:END:
...
:PROPERTIES:
:ID:       261b6019-3275-46cd-9c4d-6a87715b2aac
:END:
...
** Roam
:PROPERTIES:
:ID:       044b9a58-0e37-4d63-998a-ef5adb1d6d6d
:END:
...
*** V1 Config
:PROPERTIES:
:ID:       29d5789a-8b41-4a47-ac99-f4fa99f7a24d
:END:
...
*** V2 Config
:PROPERTIES:
:ID:       e2a56f97-d357-47b3-be28-656a646f8130
:END:
#+begin_src emacs-lisp
  ;; (use-package org-roam
  ;;   :ensure t
...
*** Org Roam Server
:PROPERTIES:
:ID:       4b4a15da-b68b-4cb2-8586-a0b12db46e30
:END:
...
*** Org Roam Protocol
:PROPERTIES:
:ID:       697965ea-e41e-484a-bfa6-788654d00269
:END:
...
:PROPERTIES:
:ID:       16c07a10-0170-41b0-b8b1-28ac9dd8e057
:END:
...
*** Flycheck
:PROPERTIES:
:ID:       c041d661-1ff9-4fe8-9773-d8f44009695e
:END:
...
*** Origami
:PROPERTIES:
:ID:       4280af62-fbd9-47d2-86b2-d003b33061ee
:END:
...
*** Company Mode
:PROPERTIES:
:ID:       1f543285-1d51-47dd-9086-8c2834a56b97
:END:
...
*** Treemacs
:PROPERTIES:
:ID:       40382653-230f-41cd-81a6-01c368460996
:END:
#+begin_src emacs-lisp
...
(use-package org-gcal
  ...
  (setq org-gcal-client-id "367256572210-m73qcnfg3v1eiknjrtgk8runc6emmov5.apps.googleusercontent.com"
        ...
        org-gcal-fetch-file-alist '(("carwinyoung@gmail.com" .  "~/Documents/Notes/cal-personal.org")
                                    ("carwin@mobomo.com" .  "~/Documents/Notes/cal-mobomo.org"))))
...
#+begin_src emacs-lisp
(defun cy/org-gcal-flush-and-refetch ()
  (interactive)
;;; Commentary:
...
;;; Code:
  ...
  ;; Find agenda files
  (defvar ogf-agendapath "/Path/To/My/Folder/With/AgendaFiles")
...
* Desktop Setup
:PROPERTIES:
:ID:       f0d8a5d7-514f-49c5-ac69-49011c6091f0
:END:
