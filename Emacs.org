...
;;   :hook go-mode
;;   :init
;;   (add-to-list 'load-path (expand-file-name "~/go/src/golang.org/x/lint/misc/emacs")))
...
#+begin_src shell :noweb yes :exports none :mkdirp yes :tangle /home/narwic/Projects/Home/dotfiles/tangled/symlinks.sh
<<symlinks>>
#+end_src
