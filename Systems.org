...
(setq cy/system-settings
      (map-merge
       ...
       `((desktop/dpi . 180)
         ...
         (user/home . "~/")
         (user/config . "~/.config/")
         (user/fonts . "~/.local/fonts")
         (user/notes . "~/Notes/")
         (user/dots . "~/Projects/home/dotfiles/")
         (user/dots/output . "~/Projects/home/dotfiles/tangled/")
...
(when (equal system-name "blank.local")
  `((desktop/dpi . 90)
    ...
    (user/dots . "~/Projects/dotfiles/")
    (user/dots/output . "~/Projects/dotfiles/tangled/")
...
#+begin_src emacs-lisp :tangle ~/.emacs.d/tangle-dotfiles.el :noweb yes
(require 'org)
